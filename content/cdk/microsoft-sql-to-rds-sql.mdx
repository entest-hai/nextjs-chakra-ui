...
dbSecurityGroup.addIngressRule(
  aws_ec2.Peer.securityGroupId(ec2MySqlSecurityGroup.securityGroupId),
  aws_ec2.Port.tcp(1433)
)
```
...
const rds = new aws_rds.DatabaseInstance(this, 'RdsDbMigrationDemo', {
  deletionProtection: false,
  engine: aws_rds.DatabaseInstanceEngine.sqlServerSe({
    version: aws_rds.SqlServerEngineVersion.VER_15_00_4043_16_V1
  }),
...
const sourceEndpoint = new aws_dms.CfnEndpoint(
  ...
  'DmsSourceEndpointRdsSqlServerEc2',
  {
    ...
    serverName: 'ec2-13-215-254-14.ap-southeast-1.compute.amazonaws.com',
    port: 1433,
    username: 'awssct',
    password: 'Password1',
    sslMode: 'none'

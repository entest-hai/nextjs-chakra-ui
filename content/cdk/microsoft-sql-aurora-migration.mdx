...
<img
  width="802"
  alt="SqlServerDmsDiagram"
  src="https://user-images.githubusercontent.com/20411077/174956389-d62cda7c-2e04-473b-b556-cd187ff7970c.png"
/>
...
```tsx
// db security group
this.dbSecurityGroup = new aws_ec2.SecurityGroup(this, 'SecurityGroupForDb', {

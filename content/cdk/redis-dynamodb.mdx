...
- [elastic cache re-invent 2021 8:22](https://www.youtube.com/watch?v=_4SkEy6r-C4)
  ...
  - two read replica node per shard, primary nodes accross azs, failover primary -[IAM auth](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/IAM.Overview.html#IAM.Overview.ManagingAccess)

---
title: Upload to S3 from Browser using AWS-SDK-JS
description: Upload to S3 from Browser using AWS-SDK-JS
author: estheragbaje
...
[GitHub](https://github.com/entest-hai/aws-sdk-js-browser)
